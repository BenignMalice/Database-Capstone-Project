...
/**
 * This class represents a utility for displaying overdue projects from the database.
 */
...
public class OverdueProjects {
    ...
    /**
     * Constructs an OverdueProjects object with a specified database connection.
     *
     * @param connection The database connection.
     */
    
    public OverdueProjects(Connection connection) {
        this.connection = connection;
    }

    /**
     * Displays a list of overdue projects from the database.
     */
