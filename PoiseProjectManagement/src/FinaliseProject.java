...
/**
 * This class represents a utility for finalising a project in the database and displaying its details.
 */
...
public class FinaliseProject {
    ...
    /**
     * Constructs a FinaliseProject object with a specified database connection.
     *
    ...
    /**
     * Finalises a project by updating its status and completion date in the database.
     * Displays the finalised project details if successful.
     *
     * @param scanner The Scanner object to read user input.
     */
    
    public void finaliseProject(Scanner scanner) {
        System.out.println("Enter project number to finalise: ");
